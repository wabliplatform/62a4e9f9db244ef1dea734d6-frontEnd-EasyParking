...
(function(root, factory) {
  ...
  describe('User', function() {
    ...
    it('should have the property userDestination (base name: "UserDestination")', function() {
      // uncomment below and update the code to test the property userDestination
      //var instance = new TempApi.User();
      //expect(instance).to.be();
    });
